...
#ifndef MOTION_PREDICT__MOTION_PREDICT_HPP_
#define MOTION_PREDICT__MOTION_PREDICT_HPP_

#include <Eigen/Dense>
#include <vector>

#include "cav_msgs/msg/external_object.hpp"
#include "cav_msgs/msg/predicted_state.hpp"
#include "cav_msgs/msg/external_object_list.hpp"
...
*/
cav_msgs::msg::PredictedState predictState(
...
*/
cav_msgs::msg::PredictedState externalPredict(
  const cav_msgs::msg::ExternalObject & obj,
  const double delta_t, const double ax, const double ay,
...
*/
std::vector<cav_msgs::msg::PredictedState> predictPeriod(
  const cav_msgs::msg::ExternalObject & obj,
  const double delta_t,
  const double period, const double ax,
  const double ay,
  const double process_noise_max,
...
\param  confidence_drop_rate rate of drop in confidence with time
*/
cav_msgs::msg::PredictedState predictStep(
...
#endif  // MOTION_PREDICT__MOTION_PREDICT_HPP_
