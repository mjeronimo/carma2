...
std::shared_ptr<carma_utils::CarmaLifecycleNode>
CarmaLifecycleNode::shared_from_this()
{
  return std::static_pointer_cast<carma_utils::CarmaLifecycleNode>(
...
RCLCPP_COMPONENTS_REGISTER_NODE(carma_utils::CarmaLifecycleNode)
